...
function mapProduct(p: any) {
  ...
  return {
    ...
    price: p.price == null ? "" : String(p.price), currency: p.currency || "VND",
    ...
    images: (p.product_images || []).sort((a:any,b:any)=>(a.sort_order||0)-(b.sort_order||0)).map((x:any)=>({id:x.id,url:x.storage_path,alt:x.alt||"",sort_order:x.sort_order||0}))
  };
}
